...
export default function WelcomeScreen() {
  ...
  // Redirect authenticated users back to tabs if they navigate here with browser back button
  useEffect(() => {
    if (isAuthenticated && Platform.OS === 'web') {
      // Small delay to avoid immediate redirect which can cause navigation issues
